...
git push --verbose upstream "$GENERATED_BRANCH":master
...
git push upstream "$COCOS_BRANCH"
...
# 7. 
curl --user "angeltown:$GH_PASSWORD" --request POST --data '{ "title": "$COMMITTAG : updating submodule reference to latest autogenerated bindings", "body": "", "head": "angeltown:${COCOS_BRANCH}", "base": "travis"}' https://api.github.com/repos/dumganhar/cocos2d-x/pulls
