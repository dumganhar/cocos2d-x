...
extern const JSClass  *jsb_cocos2d_experimental_ui_WebView_class;
...
bool js_cocos2dx_experimental_webView_WebView_WebView(JSContext *cx, uint32_t argc, JS::Value *vp);
