...
bool js_cocos2dx_extension_ControlButton_create(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    do {
        if (argc == 1) {
            ...
            JS::Value jsret = JS::NullValue();
            if (ret) {
                jsret = JS::ObjectValue(*js_get_or_create_jsobject<cocos2d::extension::ControlButton>(cx, (cocos2d::extension::ControlButton*)ret));
            } else {
                jsret = JS::NullValue();
            };
            args.rval().set(jsret);
...
bool js_cocos2dx_extension_ControlColourPicker_getHuePicker(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    if (argc == 0) {
        ...
        JS::RootedValue jsret(cx);
        if (ret) {
            jsret = JS::ObjectValue(*js_get_or_create_jsobject<cocos2d::extension::ControlHuePicker>(cx, (cocos2d::extension::ControlHuePicker*)ret));
        } else {
            jsret = JS::NullValue();
        };
        args.rval().set(jsret);
...
bool js_cocos2dx_extension_ControlColourPicker_getcolourPicker(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    if (argc == 0) {
        ...
        JS::RootedValue jsret(cx);
        if (ret) {
            jsret = JS::ObjectValue(*js_get_or_create_jsobject<cocos2d::extension::ControlSaturationBrightnessPicker>(cx, (cocos2d::extension::ControlSaturationBrightnessPicker*)ret));
        } else {
            jsret = JS::NullValue();
        };
        args.rval().set(jsret);
...
bool js_cocos2dx_extension_ControlPotentiometer_getProgressTimer(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    if (argc == 0) {
        ...
        JS::RootedValue jsret(cx);
        if (ret) {
            jsret = JS::ObjectValue(*js_get_or_create_jsobject<cocos2d::ProgressTimer>(cx, (cocos2d::ProgressTimer*)ret));
        } else {
            jsret = JS::NullValue();
        };
        args.rval().set(jsret);
...
bool js_cocos2dx_extension_ControlSlider_create(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    do {
        if (argc == 3) {
            ...
            JS::Value jsret = JS::NullValue();
            if (ret) {
                jsret = JS::ObjectValue(*js_get_or_create_jsobject<cocos2d::extension::ControlSlider>(cx, (cocos2d::extension::ControlSlider*)ret));
            } else {
                jsret = JS::NullValue();
            };
            args.rval().set(jsret);
...
bool js_cocos2dx_extension_ControlSwitch_create(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    do {
        if (argc == 4) {
            ...
            JS::Value jsret = JS::NullValue();
            if (ret) {
                jsret = JS::ObjectValue(*js_get_or_create_jsobject<cocos2d::extension::ControlSwitch>(cx, (cocos2d::extension::ControlSwitch*)ret));
            } else {
                jsret = JS::NullValue();
            };
            args.rval().set(jsret);
...
bool js_cocos2dx_extension_ScrollView_create(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    do {
        if (argc == 0) {
            ...
            JS::Value jsret = JS::NullValue();
            if (ret) {
                jsret = JS::ObjectValue(*js_get_or_create_jsobject<cocos2d::extension::ScrollView>(cx, (cocos2d::extension::ScrollView*)ret));
            } else {
                jsret = JS::NullValue();
            };
            args.rval().set(jsret);
...
bool js_cocos2dx_extension_TableView_cellAtIndex(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    if (argc == 1) {
        ...
        JS::RootedValue jsret(cx);
        if (ret) {
            jsret = JS::ObjectValue(*js_get_or_create_jsobject<cocos2d::extension::TableViewCell>(cx, (cocos2d::extension::TableViewCell*)ret));
        } else {
            jsret = JS::NullValue();
        };
        args.rval().set(jsret);
...
bool js_cocos2dx_extension_EventAssetsManagerEx_getAssetsManagerEx(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    if (argc == 0) {
        ...
        JS::RootedValue jsret(cx);
        if (ret) {
            jsret = JS::ObjectValue(*js_get_or_create_jsobject<cocos2d::extension::AssetsManagerEx>(cx, (cocos2d::extension::AssetsManagerEx*)ret));
        } else {
            jsret = JS::NullValue();
        };
        args.rval().set(jsret);
...
bool js_cocos2dx_extension_AssetsManagerEx_getLocalManifest(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    if (argc == 0) {
        ...
        JS::RootedValue jsret(cx);
        if (ret) {
            jsret = JS::ObjectValue(*js_get_or_create_jsobject<cocos2d::extension::Manifest>(cx, (cocos2d::extension::Manifest*)ret));
        } else {
            jsret = JS::NullValue();
        };
        args.rval().set(jsret);
