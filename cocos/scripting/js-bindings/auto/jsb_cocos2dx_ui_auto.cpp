...
{
    cocos2d::ui::LayoutParameter* cobj = (cocos2d::ui::LayoutParameter*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_LayoutParameter_createCloneInstance : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= native_ptr_to_seval<cocos2d::ui::LayoutParameter>((cocos2d::ui::LayoutParameter*)result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_LayoutParameter_createCloneInstance : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::LayoutParameter* cobj = (cocos2d::ui::LayoutParameter*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_LayoutParameter_copyProperties : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_LayoutParameter_copyProperties : Error processing arguments");
...
{
    cocos2d::ui::Button* cobj = (cocos2d::ui::Button*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Button_setTitleLabel : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        ok &= seval_to_native_ptr(args[0], &arg0);
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_Button_setTitleLabel : Error processing arguments");
...
{
    cocos2d::ui::Button* cobj = (cocos2d::ui::Button*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Button_getTitleLabel : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= native_ptr_to_seval<cocos2d::Label>((cocos2d::Label*)result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_Button_getTitleLabel : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::Text* cobj = (cocos2d::ui::Text*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Text_getLetter : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        int arg0 = 0;
        ok &= seval_to_int32(args[0], (int32_t *)&arg0);
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_Text_getLetter : Error processing arguments");
...
{
    cocos2d::ui::Slider* cobj = (cocos2d::ui::Slider*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Slider_getSlidBallDisabledRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= native_ptr_to_seval<cocos2d::Sprite>((cocos2d::Sprite*)result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_Slider_getSlidBallDisabledRenderer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::Slider* cobj = (cocos2d::ui::Slider*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Slider_getSlidBallRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= native_ptr_to_seval<cocos2d::Node>((cocos2d::Node*)result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_Slider_getSlidBallRenderer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::Slider* cobj = (cocos2d::ui::Slider*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Slider_getSlidBallPressedRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= native_ptr_to_seval<cocos2d::Sprite>((cocos2d::Sprite*)result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_Slider_getSlidBallPressedRenderer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::Slider* cobj = (cocos2d::ui::Slider*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Slider_getSlidBallNormalRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= native_ptr_to_seval<cocos2d::Sprite>((cocos2d::Sprite*)result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_Slider_getSlidBallNormalRenderer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::Scale9Sprite* cobj = (cocos2d::ui::Scale9Sprite*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Scale9Sprite_copyTo : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        ok &= seval_to_native_ptr(args[0], &arg0);
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_Scale9Sprite_copyTo : Error processing arguments");
        cobj->copyTo(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
static bool js_cocos2dx_ui_EditBox_getFontSize(se::State& s)
{
    ...
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getFontSize : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        int result = cobj->getFontSize();
        ok &= int32_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getFontSize : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getInputMode : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= int32_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getInputMode : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontName : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= std_string_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontName : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontSize : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= int32_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontSize : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getReturnType : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= int32_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getReturnType : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getFontName : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= std_string_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getFontName : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getFontColor : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= Color4B_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getFontColor : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getInputFlag : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= int32_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getInputFlag : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getTextHorizontalAlignment : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        int result = (int)cobj->getTextHorizontalAlignment();
        ok &= int32_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getTextHorizontalAlignment : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontColor : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= Color4B_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontColor : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_setTextHorizontalAlignment : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::TextHAlignment arg0;
        ok &= seval_to_int32(args[0], (int32_t *)&arg0);
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_setTextHorizontalAlignment : Error processing arguments");
        cobj->setTextHorizontalAlignment(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
static bool js_cocos2dx_ui_ScrollViewBar_setAutoHideEnabled(se::State& s)
{
    ...
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_setAutoHideEnabled : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_setAutoHideEnabled : Error processing arguments");
...
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_onScrolled : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::Vec2 arg0;
        ok &= seval_to_Vec2(args[0], &arg0);
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_onScrolled : Error processing arguments");
...
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_isAutoHideEnabled : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= boolean_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_isAutoHideEnabled : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_setAutoHideTime : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        float arg0 = 0;
        ok &= seval_to_float(args[0], &arg0);
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_setAutoHideTime : Error processing arguments");
...
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_getWidth : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= float_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_getWidth : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_getPositionFromCorner : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= Vec2_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_getPositionFromCorner : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_setPositionFromCorner : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::Vec2 arg0;
        ok &= seval_to_Vec2(args[0], &arg0);
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_setPositionFromCorner : Error processing arguments");
...
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_getAutoHideTime : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= float_to_seval(result, &s.rval());
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_getAutoHideTime : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    JSB_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_setWidth : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        float arg0 = 0;
        ok &= seval_to_float(args[0], &arg0);
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_setWidth : Error processing arguments");
        cobj->setWidth(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
static bool js_cocos2dx_ui_ScrollViewBar_create(se::State& s)
{
    ...
    if (argc == 2) {
        ...
        ok &= seval_to_native_ptr(args[0], &arg0);
        ok &= seval_to_int32(args[1], (int32_t *)&arg1);
        JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_create : Error processing arguments");
        auto result = cocos2d::ui::ScrollViewBar::create(arg0, arg1);
        result->retain();
        auto obj = se::Object::createObjectWithClass(__jsb_cocos2d_ui_ScrollViewBar_class, false);
        obj->setPrivateData(result);
        s.rval().setObject(obj);
        return true;
    }
...
static bool js_cocos2dx_ui_ScrollViewBar_constructor(se::State& s)
{
    ...
    ok &= seval_to_native_ptr(args[0], &arg0);
    ok &= seval_to_int32(args[1], (int32_t *)&arg1);
    JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_constructor : Error processing arguments");
...
static bool js_cocos2dx_ui_ScrollViewBar_ctor(se::State& s)
{
    ...
    ok &= seval_to_native_ptr(args[0], &arg0);
    ok &= seval_to_int32(args[1], (int32_t *)&arg1);
    JSB_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_ctor : Error processing arguments");
    cocos2d::ui::ScrollViewBar* cobj = new (std::nothrow) cocos2d::ui::ScrollViewBar(arg0, arg1);
    s.thisObject()->setPrivateData(cobj);
    s.thisObject()->addRef();
    return true;
...
bool js_cocos2d_ui_ScrollViewBar_finalize(se::State& s)
{
    if (s.nativeThisObject() != nullptr)
    {
        cocos2d::log("jsbindings: finalizing JS object %p (cocos2d::ui::ScrollViewBar)", s.nativeThisObject());
        cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
        if (cobj->getReferenceCount() == 1)
            cobj->autorelease();
        else
...
bool js_register_cocos2dx_ui_ScrollViewBar(se::Object* obj)
{
    ...
    cls->defineFinalizedFunction(_SE(js_cocos2d_ui_ScrollViewBar_finalize));
    cls->install();
    ...
    se::ScriptEngine::getInstance()->executeScriptBuffer("(function () { ccui.ScrollViewBar.extend = cc.Class.extend; })()");
    return true;
}
