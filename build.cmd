...
:build
%_buildprefix% %_msbuildexe% "%~dp0build\\cocos2d-win32.vc2012.sln" /nologo /maxcpucount /verbosity:minimal /nodeReuse:false /fileloggerparameters:Verbosity=diag;LogFile="%~dp0msbuild.log";Append %* %_buildpostfix%
goto :eof